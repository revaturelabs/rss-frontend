...
import { AccountPageComponent } from './User/user/components/account-page/account-page.component';
...
import { QuizPageComponent } from './Quiz1/employee/quiz-page/quiz-page.component';
import { AccountSettingsPageComponent } from './User/user/components/account-settings-page/account-settings-page.component';
import { IndividualQuizPageComponent } from './Quiz1/employee/individual-quiz-page/individual-quiz-page.component';
import { LandingPageComponent } from './LandingPage/components/landing-page/landing-page.component';
import { ShoppingCartComponent } from './Cart/shopping-cart/shopping-cart.component';
import { LoginPageComponent } from './User/user/components/login-page/login-page.component';
